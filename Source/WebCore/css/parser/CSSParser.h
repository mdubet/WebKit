...
public:
    ...
    static RefPtr<StyleRuleBase> parseRule(const CSSParserContext&, StyleSheetContents*, const String&, IsNestedContext = IsNestedContext::No);
    ...
    WEBCORE_EXPORT std::optional<CSSSelectorList> parseSelector(const String&, StyleSheetContents* = nullptr, IsNestedContext = IsNestedContext::No);
